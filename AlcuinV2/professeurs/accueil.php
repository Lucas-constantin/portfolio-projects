...
<body class="flex bg-gray-100 text-gray-900 h-screen">
    ...
    <main class="flex-1 p-6 overflow-y-auto">
        <header class="bg-blue-700 text-white p-6 shadow rounded-lg mb-6 text-center">
            <h1 class="text-3xl font-bold mb-2">Espace Professeur</h1>
            <p class="text-sm opacity-80">Bienvenue sur le portail dédié aux enseignants de l'ESAIP</p>
        </header>

        <section class="bg-white rounded-lg shadow p-6 max-w-3xl mx-auto">
            <h2 class="text-xl font-semibold mb-4">Fonctionnalités disponibles</h2>
            <ul class="space-y-3 text-gray-700">
                <li class="flex items-center"><span class="mr-2">📥</span> Consulter et corriger les rapports de stage</li>
                <li class="flex items-center"><span class="mr-2">📝</span> Attribuer et gérer les notes des élèves</li>
                <li class="flex items-center"><span class="mr-2">📰</span> Suivre les actualités de l’établissement</li>
            </ul>
        </section>
    </main>
</body>
