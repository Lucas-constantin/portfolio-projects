...
<body class="flex bg-gray-100 text-gray-900 h-screen overflow-hidden">
    ...
    <nav class="group flex flex-col bg-blue-600 text-white w-20 hover:w-64 transition-all duration-300 overflow-hidden shadow-lg">
        ...
        <ul class="mt-6 space-y-2 px-2">
            ...
            <li><a href="logout.php" class="flex items-center space-x-4 px-4 py-2 rounded-lg border-l-4 border-transparent hover:border-white bg-red-500 hover:bg-red-600 transition"><span>🚪</span><span class="hidden group-hover:inline">Déconnexion</span></a></li>
        </ul>
    </nav>
